...
**Why `.aimaestro/`**: This directory contains all AI Maestro agent system configuration for the project.
...
```json
{
  "$schema": "https://aimaestro.github.io/schemas/team-registry.v1.json",
  "version": "1.0.0",
  "team": {
...
def get_agent_address(agent_name: str, registry_path: str = ".aimaestro/team-registry.json") -> str:
